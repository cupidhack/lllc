...
from lllc.semantics.types.bases import (
    BaseTypeDefinition,
    DataLocation,
    StorageSlot,
)
from lllc.semantics.types.indexable.sequence import TupleDefinition
from lllc.semantics.types.user.struct import StructDefinition
from lllc.semantics.types.utils import (
    StringEnum,
    check_constant,
    get_type_from_abi,
...
from lllc.semantics.validation.utils import validate_expected_type
from lllc.utils import keccak256

...
from lllc.old_codegen.function_definitions import (
    is_default_func,
    is_initializer,
    parse_function,
)
from lllc.old_codegen.global_context import GlobalContext
from lllc.old_codegen.lll_node import LLLnode
from lllc.semantics.types.function import FunctionVisibility, StateMutability
from lllc.typing import InterfaceImports
from lllc.utils import LOADED_LIMITS

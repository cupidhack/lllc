...
from lllc.compiler.settings import VYPER_COLOR_OUTPUT
from lllc.evm.opcodes import get_comb_opcodes
from lllc.exceptions import CompilerPanic
from lllc.old_codegen.types import BaseType, NodeType, ceil32
from lllc.utils import VALID_LLL_MACROS

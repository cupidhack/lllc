...
from lllc.ast.signatures import sig_utils
from lllc.ast.signatures.function_signature import FunctionSignature
from lllc.old_codegen.arg_clamps import make_arg_clamper
from lllc.old_codegen.context import Context, VariableRecord
from lllc.old_codegen.expr import Expr
from lllc.old_codegen.function_definitions.utils import (
    get_default_names_to_set,
    get_nonreentrant_lock,
    get_sig_statements,
)
from lllc.old_codegen.lll_node import LLLnode
from lllc.old_codegen.parser_utils import getpos, make_setter
from lllc.old_codegen.stmt import parse_body
from lllc.old_codegen.types.types import ByteArrayLike, get_size_of_type
from lllc.utils import MemoryPositions

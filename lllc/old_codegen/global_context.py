...
from lllc.ast.signatures.function_signature import (
    ContractRecord,
    VariableRecord,
)
from lllc.exceptions import CompilerPanic, InvalidType, StructureException
from lllc.old_codegen.types import InterfaceType, parse_type
...
class GlobalContext:
    ...
    def get_global_context(
        ...
        from lllc.ast.signatures.interface import (
            extract_sigs,

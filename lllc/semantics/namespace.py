...
from lllc.evm.opcodes import OPCODES
...
class Namespace(dict):
    ...
    def __init__(self):
        ...
        self._scopes = []
        # FLAG cyclic imports!
        from lllc.builtin_functions.functions import get_builtin_functions
        from lllc.semantics import environment
        from lllc.semantics.types import get_types

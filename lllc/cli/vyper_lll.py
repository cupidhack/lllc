...
from lllc.lll.s_expressions import parse_s_exp
from lllc.old_codegen.parser_utils import LLLnode
...
def _parse_args(argv):
    ...
    parser.add_argument(
        "input_file", help="LLL sourcecode to compile",
    )
    parser.add_argument(
        "--version", action="version", version=f"{lllc.__version__}",
    )
    parser.add_argument(
        "-f",

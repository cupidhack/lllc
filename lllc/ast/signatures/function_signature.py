...
from lllc.exceptions import FunctionDeclarationException, StructureException
from lllc.old_codegen.lll_node import LLLnode
from lllc.old_codegen.parser_utils import check_single_exit, getpos
...
from lllc.utils import fourbytes_to_int, keccak256

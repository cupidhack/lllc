...
from lllc.old_codegen.abi import abi_decode
from lllc.old_codegen.lll_node import LLLnode
from lllc.old_codegen.parser_utils import getpos, pack_arguments
...
def make_call(stmt_expr, context):
    ...
    # TODO check this out
    from lllc.old_codegen.expr import parse_sequence

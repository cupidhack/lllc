...
from lllc.ast.signatures import FunctionSignature
from lllc.old_codegen import context as ctx
from lllc.old_codegen.context import Constancy
# NOTE black/isort conflict >>
from lllc.old_codegen.function_definitions.parse_external_function import (
    parse_external_function,
)
# NOTE black/isort conflict >>
from lllc.old_codegen.function_definitions.parse_internal_function import (
    parse_internal_function,
)
from lllc.old_codegen.memory_allocator import MemoryAllocator
from lllc.utils import calc_mem_gas

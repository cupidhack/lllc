...
from lllc.semantics.environment import (
    CONSTANT_ENVIRONMENT_VARS,
    MUTABLE_ENVIRONMENT_VARS,
)
from lllc.semantics.namespace import get_namespace
from lllc.semantics.types.abstract import IntegerAbstractType
from lllc.semantics.types.bases import DataLocation
from lllc.semantics.types.function import (
    ContractFunction,
    FunctionVisibility,
    StateMutability,
)
from lllc.semantics.types.indexable.sequence import (
    ArrayDefinition,
    TupleDefinition,
)
from lllc.semantics.types.user.event import Event
from lllc.semantics.types.user.struct import StructDefinition
from lllc.semantics.types.utils import get_type_from_annotation
from lllc.semantics.types.value.boolean import BoolDefinition
from lllc.semantics.types.value.numeric import Uint256Definition
from lllc.semantics.validation.annotation import StatementAnnotationVisitor
from lllc.semantics.validation.base import VyperNodeVisitorBase

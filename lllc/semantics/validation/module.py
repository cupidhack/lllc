...
import lllc.builtin_interfaces
...
from lllc.semantics.types.function import ContractFunction
from lllc.semantics.types.user.event import Event
from lllc.semantics.types.utils import check_literal, get_type_from_annotation
...
from lllc.typing import InterfaceDict
...
def _get_builtin_interfaces():
    interface_names = [i.name for i in pkgutil.iter_modules(lllc.builtin_interfaces.__path__)]
    return {
        name: {
            "type": "vyper",

...
from lllc.ast.signatures.function_signature import VariableRecord
from lllc.ast.validation import validate_call_args
from lllc.builtin_functions.convert import convert
from lllc.evm.opcodes import version_check
from lllc.exceptions import (
    ArgumentException,
    CompilerPanic,
    InvalidLiteral,
    InvalidType,
...
from lllc.old_codegen.arg_clamps import int128_clamp
from lllc.old_codegen.expr import Expr
from lllc.old_codegen.keccak256_helper import keccak256_helper
from lllc.old_codegen.parser_utils import (
    LLLnode,
    add_variable_offset,
    get_length,
    getpos,
...
from lllc.old_codegen.types import (
    BaseType,
    ByteArrayLike,
    ByteArrayType,
    ListType,
)
from lllc.old_codegen.types import StringType as OldStringType
from lllc.old_codegen.types import is_base_type
from lllc.semantics.types.abstract import (
...
from lllc.semantics.types.bases import DataLocation, ValueTypeDefinition
from lllc.semantics.types.indexable.sequence import ArrayDefinition
from lllc.semantics.types.utils import get_type_from_annotation
from lllc.semantics.types.value.address import AddressDefinition
from lllc.semantics.types.value.array_value import (
    BytesArrayDefinition,
    BytesArrayPrimitive,
    StringDefinition,
    StringPrimitive,
)
from lllc.semantics.types.value.bytes_fixed import Bytes32Definition
from lllc.semantics.types.value.numeric import (
    DecimalDefinition,
    Int128Definition,
    Int256Definition,
    Uint256Definition,
)
from lllc.semantics.validation.utils import (
    get_common_types,
    get_possible_types_from_node,
    validate_expected_type,
)
from lllc.utils import (
    DECIMAL_DIVISOR,
    MemoryPositions,
    SizeLimits,
    bytes_to_int,
...
def get_create_forwarder_to_bytecode():
    # FLAG cyclic import?
    from lllc.lll.compile_lll import assembly_to_evm
...
class Sqrt(_SimpleBuiltinFunction):
    ...
    def build_LLL(self, expr, args, kwargs, context):
        ...
        from lllc.builtin_functions.utils import generate_inline_function
